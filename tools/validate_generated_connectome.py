#!/usr/bin/env python3
"""Independent structural validation for FlyBrain V1.10 generated data."""
...
TARGET = 16669
MAGIC = b"FBC102\x00\x00"  # Binary format remains FBC102; app release is V1.10.
NODE_SIZE = 25
EDGE_SIZE = 12
HEADER_SIZE = 16
...
def main(root: Path) -> None:
    ...
    assert report["flybrain_version"] == "1.10"
    ...
    print("FBC102 independent validation for FlyBrain V1.10: OK")
    print(f"neurons={n}")
    print(f"edges={e}")
