#!/usr/bin/env python3
"""Independent structural validation for FlyBrain V1.08 generated data."""
...
TARGET = 16669
MAGIC = b"FBC102\x00\x00"  # Binary format remains FBC102; app release is V1.08.
NODE_SIZE = 25
EDGE_SIZE = 12
HEADER_SIZE = 16
...
def main(root: Path) -> None:
    ...
    assert report["flybrain_version"] == "1.08"
